...
import { createDateFromDayValue, getBeginningOfYear, getPriorMonthEnd } from '../../../utils/dates';
import { formatFilterBarValuesForServer, IFilterBarValues, IServerFilterValues } from '../../../components/FilterBar';
import { fetchData, getUserToken, timeout } from '../../../utils/general';
...
const getDataFromApi = async(queryType: string, appUserAttributes: IAuthenticatorContext, endDate: DayValue, filterBarValues: IServerFilterValues, modalContext: ModalContextType):
  ...
  const callBody = { 
    ...
    queryType: queryType, 
    endDate: getPriorMonthEnd(createDateFromDayValue(endDate)), 
